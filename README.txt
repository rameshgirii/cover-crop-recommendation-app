...
Plant structure cleanup
The preferred plant structure menu is simplified to three grouped categories only: Upright, Basal rosettee, and Creeping. Raw plant structure descriptions from the dataset are mapped internally to one of these user-facing options.
